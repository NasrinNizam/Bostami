    ...
    <nav>
        <div className="container px-[15px]">
           <div className="menu-row p-5 flex flex-wrap justify-between mb-[30px]">
                ...
                <MdMenuBook onClick={menu} className="text-3xl text-[#e12a72] md:hidden" />
                {
                    show &&
                    ...
                    <div className="theme w-[45px] h-[45px] bg-white rounded-3xl mt-[30px] text-[22px] font-light flex justify-center items-center text-center hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] hover:text-white dark:bg-[#1d1d1d] dark:text-[#A6A6A6] transition duration-300" onClick={darkMode}>
               ...
               <div className="menu flex">
                    ...
                    <div className="theme w-[45px] h-[45px] bg-white rounded-3xl ml-[30px] text-[22px] font-light flex justify-center items-center text-center hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] hover:text-white dark:bg-[#1d1d1d] dark:text-[#A6A6A6] transition duration-300" onClick={darkMode}>
                        {mode? <CiSun /> :  <HiOutlineMoon/>}
                    </div> 
                </div>
               </div>
